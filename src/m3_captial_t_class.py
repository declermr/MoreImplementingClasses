...
class CapitalT(object):
    ...
    def clone(self):
        ...
        cap = CapitalT(self.intersection, self.width, self.height, self.thickness)
        cap.h_rect.fill_color = self.h_rect.fill_color
        cap.h_rect.outline_color = self.h_rect.outline_color
        cap.v_rect.fill_color = self.v_rect.fill_color
        cap.v_rect.outline_color = self.v_rect.outline_color
