...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cloned = 0
        self.start_xi = self.start.x
        self.end_xi = self.end.x
        self.start_yi = self.start.y
        self.end_yi = self.end.y
    ...
    def reset(self):
        ...
        self.start.x = self.start_xi
        self.end.x = self.end_xi
        self.start.y = self.start_yi
        self.end.y = self.end_yi
